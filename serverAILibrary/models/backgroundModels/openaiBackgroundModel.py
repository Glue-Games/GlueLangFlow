from serverAILibrary.settings.modelsConfig import OPENAI_BACKGROUND_MODEL_PROMPT
...
class OpenAIBackgroundModel:
    ...
    def fill_background_image(self, img, context=OPENAI_BACKGROUND_MODEL_PROMPT):
